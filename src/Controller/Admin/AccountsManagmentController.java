...
public class AccountsManagmentController implements Initializable {
   ...
   @FXML
    ...
    @FXML
    private TableColumn<Account, carrency> tccarrency;

    @FXML
    private TableColumn<Account, name> tcusername;
    ...
    @FXML
    private TableColumn<Account, creation> tccreation;

    @FXML
    private TableColumn<Account, number> tcnumber;

    @FXML
    private TableColumn<Account, balance> tcbalance;
    ...
    @FXML
    private TableColumn<Account, id> tcid;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        tccreation.setCellValueFactory(new PropertyValueFactory("creation"));
        tcbalance.setCellValueFactory(new PropertyValueFactory("balance"));
        tccarrency.setCellValueFactory(new PropertyValueFactory("carrency"));
